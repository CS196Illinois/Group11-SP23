    ...
    try: 
        ...
        for e in listinfo:
            ...
            try:
                ...
                priceElement = ""
            try:
                addressElement = e.find_element(By.CLASS_NAME, "street-address").text
            except:
                addressElement = ""
            try:
                localityElement = e.find_element(By.CLASS_NAME, "locality").text
            except:
                localityElement = ""
            ...
            dfElement['Address'] = addressElement
            dfElement['Locality'] = localityElement
